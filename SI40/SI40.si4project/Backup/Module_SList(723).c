...
int32_t ModuleSList_Exchange2Pos(Node *pNode,int32_t pos1,int32_t pos2)
{
    ...
    if(i<pos1)
    {
        if(ModuleDList_DebugTest_Enable==1)
        {
            ModuleDList_DebugPrintf("SList Exchange2Pos Err.(Pos1>max)\r\n");
        }
        return 0;
    }
    ...
    if(i<pos2)
    {
        if(ModuleDList_DebugTest_Enable==1)
        {
            ModuleDList_DebugPrintf("SList Exchange2Pos Err.(Pos2>max)\r\n");
        }
        return 0;
    }
...
int32_t ModuleSList_Arrange(Node *pNode)
{
    ...
    if(NULL==pHead)
    {
        if(ModuleDList_DebugTest_Enable==1)
        {
            ModuleDList_DebugPrintf("SList Arrange NULL.\r\n");
        }
        return 0;
    }
    ...
    if(ModuleDList_DebugTest_Enable==1)
    {
        ModuleDList_DebugPrintf("SList Arrange OK.\r\n");
    }
    return 0;
}
/*
