...

    {
        ...
        if(Hci_AbedOrAway.bit0==0)
        {
            if( ((i32>=(ModuleMemory_psPara->ThreshsholdValue2+(4300L*ModuleMemory_psPara->Offset_H[0])))&&(0==ModuleMemory_psPara->ThreshsholdValue2&0x80000000))
                ||((i32>=(ModuleMemory_psPara->ThreshsholdValue2-(4300L*ModuleMemory_psPara->Offset_H[1])))&&(1==ModuleMemory_psPara->ThreshsholdValue2&0x80000000)))
            {
                Hci_OffSet_TimerS++;
            }
            else
        ...
        else
        {
            if( ((i32<=(ModuleMemory_psPara->ThreshsholdValue2+(4300*ModuleMemory_psPara->Offset_L[0])))&&(0==ModuleMemory_psPara->ThreshsholdValue2&0x80000000))
                ||((i32<=(ModuleMemory_psPara->ThreshsholdValue2-(4300*ModuleMemory_psPara->Offset_L[1])))&&(1==ModuleMemory_psPara->ThreshsholdValue2&0x80000000)))
            {
                Hci_OffSet_TimerS++;
            }
            else
