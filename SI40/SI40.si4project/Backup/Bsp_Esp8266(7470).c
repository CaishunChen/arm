...
void BspEsp8266_100ms(void)
{
    ...
    if(BspEsp8266_s_Rx.len!=0)
    {
        ...
        //申请发送数据成功
        else if(strstr((const char *)BspEsp8266_s_Rx.pbuf,">")&&BspEsp8266_s_Rx.len==3)
        {}
        //数据发送成功
        ...
        {}
        //正确
        else if(strstr((const char *)BspEsp8266_s_Rx.pbuf,"OK"))
        {}
    }
    //----------发送
    ...
    switch(BspEsp8266_s_Tx.AtCmd)
    {
        ...
        */
        ...
        case AT_CIFSR:
            ...
            {
                // OK
                if(strstr((const char *)BspEsp8266_s_Rx.pbuf,"+CIFSR:APIP"))    //APIP  APMAC   STAIP   STAMAC
                {
                    BspEsp8266_s_Tx.state   =   0;
