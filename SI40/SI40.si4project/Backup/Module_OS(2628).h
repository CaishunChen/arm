...
#include  "app_os_cfg.h"
//临界保护
#define MODULE_OS_DISABLE_INT taskENTER_CRITICAL()
#define MODULE_OS_ENABLE_INT  taskEXIT_CRITICAL()
//系统
#define MODULE_OS_VER(ver) \
         {\
...
//任务
#define MODULE_OS_TASK_TAB(Name)       static TaskHandle_t Name=NULL;
