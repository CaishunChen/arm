...
static uint8_t Iap_SoftResetTime_100mS=0;
...
返 回 值:
*******************************************************************************/
void IAP_100msPro(void)
{
    static uint8_t first=1;
    if(first==1)
    {
        first=0;
        Iap_SoftResetTime_100mS=0;
    }
    //倒计时软复位
    if(Iap_SoftResetTime_100mS!=0)
    {
        Iap_SoftResetTime_100mS--;
        if(Iap_SoftResetTime_100mS==0)
        {
            IAP_Enter_pro(IAP_ENTERPRO_CMD_RESET,NULL,NULL);
        }
    }
}
//-------------------------------------------------------------------------------
