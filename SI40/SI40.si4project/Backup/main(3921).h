...
#define MAIN_BSP_INIT_3    MyADC_Init()
#define MAIN_BSP_INIT_4    TIM_Configuration(1);
//任务(1-20)
#define MAIN_TASK_1        App_UserTimer10msTaskCreate()
#define MAIN_TASK_2        App_UserTimer100msTaskCreate()
#define MAIN_TASK_3        App_HciTaskCreate()
//<----
#elif (defined(BASE_NRF51)||defined(BASE_NRF52)||defined(TEST_NRF52_V1))
//---->
#include "Bsp_Led.h"
#include "uctsk_Debug.h"
#include "SEGGER_RTT.h"
...
//初始化(1-20)
#define MAIN_BSP_INIT_1    BspLed_Init()
#define MAIN_BSP_INIT_2    TIM_Configuration(1);
...
//#define MAIN_BSP_INIT_5    UART_INIT(1,115200);
