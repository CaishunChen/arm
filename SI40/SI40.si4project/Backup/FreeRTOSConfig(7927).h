...
#define configIDLE_SHOULD_YIELD                                                   1             /*1-使能与空闲任务同优先级任务 建议配置为0*/
...
#define configUSE_TIME_SLICING                                                    0             /*1-使能时间片调度*/
#define configUSE_NEWLIB_REENTRANT                                                0             /*1-每个任务创建的时候分配Newlib的重入结构体*/
#define configENABLE_BACKWARD_COMPATIBILITY                                       1             /*1-新版本对老版本的兼容性*/
...
#define configCHECK_FOR_STACK_OVERFLOW                                            0             /*0-禁止栈溢出监测   1-栈溢出监测使用方法1  2-栈溢出监测使用方法2*/
...
#define configTIMER_TASK_STACK_DEPTH                                              (100)     /*配置软件定时器任务的栈空间*/
