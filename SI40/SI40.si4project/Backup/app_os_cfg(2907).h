...
*********************************************************************************************************
*/
#if		(defined(XKAP_ICARE_B_C)||defined(XKAP_ICARE_B_D)||defined(PROJECT_NRF5X_BLE)||defined(XKAP_ICARE_A_C))
...
#define  APP_CFG_TASK_DEBUG_STK_SIZE         (96u)
...
#define  APP_TASK_USERTIMER_100MS_STK_SIZE   (200u)
#else
#define  APP_TASK_USERTIMER_100MS_STK_SIZE   (128u)
#endif
//
#if		(defined(XKAP_ICARE_B_M)&&(!defined(HAIER)))
#define  APP_TASK_USERTIMER_10MS_STK_SIZE    (128u)/*(64u)*/
#else
#define  APP_TASK_USERTIMER_10MS_STK_SIZE    (128u)
#endif
//
#if		(defined(XKAP_ICARE_B_M)&&(!defined(HAIER)))
#define  APP_TASK_GPRSAPPXKAP_STK_SIZE    	(128u)/*(64u)*/
#else
#define  APP_TASK_GPRSAPPXKAP_STK_SIZE    	(128u)
#endif
//
#if		(defined(XKAP_ICARE_B_M)&&(!defined(HAIER)))
#define  APP_TASK_GSM_PARSE_STK_SIZE    	(128u)/*(96u)*/
#else
#define  APP_TASK_GSM_PARSE_STK_SIZE    	(128u)
#endif
//
#if		(defined(XKAP_ICARE_B_M)&&(!defined(HAIER)))
#define  APP_TASK_GSM_SEND_STK_SIZE    		(128u)/*(96u)*/
#else
