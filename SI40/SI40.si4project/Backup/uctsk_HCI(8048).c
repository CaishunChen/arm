            ...
            case 0:
                if(Hci_cmd==2)
                {
                    if(s_state.bit0==0)
                    {
						...
						BspLed_Mode(1,BSP_LED_E_MODE_ON,BSP_LED_E_LEVEL_2);
						BspLed_Mode(4,BSP_LED_E_MODE_FLICK,BSP_LED_E_LEVEL_2);
                        s_state.bit0=1;
                    }
                    else
                    {
                        Bsp_BuzzerMusic_PlayStop(OFF,NULL,0);
						BspLed_Mode(1,BSP_LED_E_MODE_NULL,BSP_LED_E_LEVEL_2);
						BspLed_Mode(4,BSP_LED_E_MODE_NULL,BSP_LED_E_LEVEL_2);
                        s_state.bit0=0;
                    }
                }
