...
void  App_Hci_Init (void)
{
...
#endif
    {
        ...
        {
#if   ((HARDWARE_VER==1) || (HARDWARE_VER==7) || (HARDWARE_VER==8) || (HARDWARE_VER==9)|| (HARDWARE_VER==10))
            {
...
static void Hci_Menu_InfoWifi(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			sprintf((char*)pbuf,"Signal     :%d",BspEsp8266_s_Info.SignalVal);
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			sprintf((char*)pbuf,"Flag: OnOff-%d Connect-%d%d%d%d%d",BspEsp8266_s_Info.Flag_OnOff,\
				BspEsp8266_s_Info.Flag_Connect_1,BspEsp8266_s_Info.Flag_Connect_2,BspEsp8266_s_Info.Flag_Connect_3,BspEsp8266_s_Info.Flag_Connect_4,BspEsp8266_s_Info.Flag_Connect_5);
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			//
        }
        //释放缓存
