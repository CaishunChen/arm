...
static void TOUCH_SaveParam(void)
{
	...
	pspara->Touch_usAdcX1	=	g_tTP.usAdcX1;
	pspara->Touch_usAdcY1	=	g_tTP.usAdcY1;
	pspara->Touch_usAdcX2	=	g_tTP.usAdcX2;
	pspara->Touch_usAdcY2	=	g_tTP.usAdcY2;
	pspara->Touch_usAdcX3	=	g_tTP.usAdcX3;
	pspara->Touch_usAdcY3	=	g_tTP.usAdcY3;
	pspara->Touch_usAdcX4	=	g_tTP.usAdcX4;
	pspara->Touch_usAdcY4	=	g_tTP.usAdcY4;
	pspara->Touch_XYChange	=	g_tTP.XYChange;
...
#else
	g_tTP.usAdcX1	= 	ModuleMemory_psPara->Touch_usAdcX1;
	g_tTP.usAdcY1 	= 	ModuleMemory_psPara->Touch_usAdcY1;
	g_tTP.usAdcX2 	= 	ModuleMemory_psPara->Touch_usAdcX2;
	g_tTP.usAdcY2 	= 	ModuleMemory_psPara->Touch_usAdcY2;
	g_tTP.usAdcX3 	= 	ModuleMemory_psPara->Touch_usAdcX3;
	g_tTP.usAdcY3 	= 	ModuleMemory_psPara->Touch_usAdcY3;
	g_tTP.usAdcX4 	= 	ModuleMemory_psPara->Touch_usAdcX4;
	g_tTP.usAdcY4 	= 	ModuleMemory_psPara->Touch_usAdcY4;
	g_tTP.XYChange 	= 	ModuleMemory_psPara->Touch_XYChange;
#endif
}
