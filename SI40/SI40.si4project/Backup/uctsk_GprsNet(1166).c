...
{
    MODULE_OS_TASK_CREATE("App Task GsmParse",\
                          uctsk_GsmParse,\
...
{
    MODULE_OS_TASK_CREATE("App Task GsmSend",\
                          uctsk_GsmSend,\
...
{
    MODULE_OS_TASK_CREATE("App Task GsmTest",\
                          uctsk_GsmTest,\
...
#else
        //GPRS_PWR_L;
        GSM_DMA_Tx((uint8_t*)"ATE1\r",strlen("ATE1\r"));
        MODULE_OS_DELAY_MS(100);
