        ...
        */
        ...
        case AT_CIFSR:
            ...
            if(BspEsp8266_s_Rx.len!=0)
            {
                ...
                for(j=0; j<3; j++)
                {
                    switch(j)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            p   =   strstr((const char *)BspEsp8266_s_Rx.pbuf,"+CIFSR:STATP");
                            break;
                        case 3:
                ...
                // ERR
                if(strstr((const char *)BspEsp8266_s_Rx.pbuf,"ERROR"))
                {
                    BspEsp8266_s_Tx.AtCmd   =   AT;
                    BspEsp8266_s_Tx.state   =   0;
                }
        ...
        case AT_CIPMUX:
            ...
            {
                // OK
                if(strstr((const char *)BspEsp8266_s_Rx.pbuf,"OK")) //APIP  APMAC   STAIP   STAMAC
                {
                    BspEsp8266_s_Tx.state   =   0;
                    BspEsp8266_s_Tx.AtCmd   =   AT_CIPSTART;
                }
                // ERR
                else if(strstr((const char *)BspEsp8266_s_Rx.pbuf,"ERROR"))
                {
        ...
        case AT_CIPSTART:
            if(BspEsp8266_s_Tx.state    ==  0)
            {
                BspEsp8266_s_Tx.state   =   1;
                BspEsp8266_s_Tx.cmt     =   0;
                BspEsp8266_s_Tx.pbuf    =   "AT+CIPSTART=0,\"UDP\",\"10.10.18.202\",8080,8824,0\r\n";
            }
            if(BspEsp8266_s_Rx.len!=0)
            {
                // OK
