...
#define GPRSAPP_XKAP_NET_GPRS
#define GPRSAPP_XKAP_NET_WIFI
#else
#define GPRSAPP_XKAP_NET_GPRS
#endif
//
...
#if   (defined(PROJECT_XKAP_V3)||defined(XKAP_ICARE_B_D_M)||defined(XKAP_ICARE_A_M) || defined(XKAP_ICARE_B_M))
//正式
