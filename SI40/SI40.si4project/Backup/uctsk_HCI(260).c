...
void  App_Hci_Init (void)
{
...
#endif
    {
        ...
        {
#if   ((HARDWARE_VER==1) || (HARDWARE_VER==7) || (HARDWARE_VER==8) || (HARDWARE_VER==9)|| (HARDWARE_VER==10)||(HARDWARE_VER==0xF1))
            {
...
static void Hci_Menu_Default1(void)
{
    ...
    else
    {
        ...
        else if(Hci_pbuf[17]==1)
        {
            ...
            Hci_cursor|=(1<<1);
            //
#if   ((HARDWARE_VER==1) || (HARDWARE_VER==10))
            {
                extern GUI_CONST_STORAGE GUI_BITMAP bmres36;
                GUI_DrawBitmap(&bmres36,0,0);
        ...
        switch(BspKey_Value)
        {
            ...
            case HCI_KEY_RIGHT:
                if(BspKey_KeepTimer_ms<2000)
                {
                    ...
                    BspRtc_ReadRealTime(NULL,ptm,NULL,NULL);
#if   ((HARDWARE_VER==7)||(HARDWARE_VER==10))
...
static void Hci_Menu_InfoWifi(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			sprintf((char*)pbuf,"CH1: %d Tx=%09d Rx=%09d",BspEsp8266_s_Info.Flag_Connect_1,BspEsp8266_s_Info.TxNumBuf[0],BspEsp8266_s_Info.RxNumBuf[0]);
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			sprintf((char*)pbuf,"CH2: %d Tx=%09d Rx=%09d",BspEsp8266_s_Info.Flag_Connect_2,BspEsp8266_s_Info.TxNumBuf[1],BspEsp8266_s_Info.RxNumBuf[1]);
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			sprintf((char*)pbuf,"CH3: %d Tx=%09d Rx=%09d",BspEsp8266_s_Info.Flag_Connect_3,BspEsp8266_s_Info.TxNumBuf[2],BspEsp8266_s_Info.RxNumBuf[2]);
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			sprintf((char*)pbuf,"CH4: %d Tx=%09d Rx=%09d",BspEsp8266_s_Info.Flag_Connect_4,BspEsp8266_s_Info.TxNumBuf[3],BspEsp8266_s_Info.RxNumBuf[3]);
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			sprintf((char*)pbuf,"CH5: %d Tx=%09d Rx=%09d",BspEsp8266_s_Info.Flag_Connect_5,BspEsp8266_s_Info.TxNumBuf[4],BspEsp8266_s_Info.RxNumBuf[4]);
            LCD_DispStr(0, ypos+=20, (char*)pbuf, &sfont);
			//
        }
        //释放缓存
