...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
static uint32_t ModuleDList_ListMem_Num		=	0; 	//	有效数量
static uint32_t ModuleDList_ListMem_EndNum	=	0;	//	末尾编号
...
void ModuleDList_Mem_Init(void)
{
	...
	ModuleDList_ListMem_Num		=	ModuleDList_ListMem_Num;
	ModuleDList_ListMem_EndNum	=	ModuleDList_ListMem_EndNum;
 ...
 * @return  None
 */
void ModuleDList_Mem_Get(void)
{
	// 如果 ModuleDList_ListMem_Num未达到最大，则向后取空间
	// 如果 ModuleDList_ListMem_Num已达到最大，则选取空闲空间
}
 ...
 * @return  None
 */
void ModuleDList_Mem_Free(void)
{
	// 释放链表区
	// 释放参数区
}
