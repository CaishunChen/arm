...
void BspPwr_Cmd_timer_1s(void)
{
    ...
    if(BspKey_NewSign==1)
    {
        ...
        MODULE_OS_SEM_POST(BspPwr_Sem_Cmd);
		/*
        if(s_cmd.num!=BSP_PWR_CMD_KEY_NUM_5)
        {
            s_cmd.cmd    =  BSP_PWR_CMD_TIMER;
            Count_BufferLoopPush(&BspPwr_Cmd_BufferLoop,(uint8_t*)&s_cmd,sizeof(BSP_PWR_S_CMD));
            MODULE_OS_SEM_POST(BspPwr_Sem_Cmd);
...
#ifdef  BSP_PWR_CMD_KEY1_FUN1
                    BSP_PWR_CMD_KEY1_FUN1;
#endif
                    break;
                case BSP_PWR_CMD_KEY_NUM_2:
                    DebugLogOutStr(DEBUG_E_LEVEL_INFO,"KEY2 PRESS\r\n");
#ifdef  BSP_PWR_CMD_KEY2_FUN1
                    BSP_PWR_CMD_KEY2_FUN1;
#endif
                    break;
                case BSP_PWR_CMD_KEY_NUM_3:
                    DebugLogOutStr(DEBUG_E_LEVEL_INFO,"KEY3 PRESS\r\n");
#ifdef  BSP_PWR_CMD_KEY3_FUN1
                    BSP_PWR_CMD_KEY3_FUN1;
#endif
                    break;
                case BSP_PWR_CMD_KEY_NUM_4:
                    DebugLogOutStr(DEBUG_E_LEVEL_INFO,"KEY4 PRESS\r\n");
#ifdef  BSP_PWR_CMD_KEY4_FUN1
                    BSP_PWR_CMD_KEY4_FUN1;
#endif
                    break;
                case BSP_PWR_CMD_KEY_NUM_5:
                    DebugLogOutStr(DEBUG_E_LEVEL_INFO,"KEY5 PRESS\r\n");
#ifdef  BSP_PWR_CMD_KEY5_FUN1
                    BSP_PWR_CMD_KEY5_FUN1;
#endif
                    break;
                default:
                    break;
...
#ifdef  BSP_PWR_CMD_TIMER_FUN1
            BSP_PWR_CMD_TIMER_FUN1;
#endif
            break;
        default:
            break;
