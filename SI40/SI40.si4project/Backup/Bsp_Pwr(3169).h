...
#define 	BSP_PWR_CMD_KEY1_FUN1	if(BspBrfRfEsb_s_data.Key1_num==0xFF){BspBrfRfEsb_s_data.Key1_num=0;}else{BspBrfRfEsb_s_data.Key1_num++;}BspBrfRfEsb_s_data.flag_trigger=1;
#define 	BSP_PWR_CMD_KEY2_FUN1	if(BspBrfRfEsb_s_data.Key2_num==0xFF){BspBrfRfEsb_s_data.Key2_num=0;}else{BspBrfRfEsb_s_data.Key2_num++;}BspBrfRfEsb_s_data.flag_trigger=1;
#define 	BSP_PWR_CMD_KEY3_FUN1	if(BspBrfRfEsb_s_data.Key3_num==0xFF){BspBrfRfEsb_s_data.Key3_num=0;}else{BspBrfRfEsb_s_data.Key3_num++;}BspBrfRfEsb_s_data.flag_trigger=1;
#define 	BSP_PWR_CMD_KEY4_FUN1	if(BspBrfRfEsb_s_data.Key4_num==0xFF){BspBrfRfEsb_s_data.Key4_num=0;}else{BspBrfRfEsb_s_data.Key4_num++;}BspBrfRfEsb_s_data.flag_trigger=1;
#define 	BSP_PWR_CMD_KEY5_FUN1	if(BspBrfRfEsb_s_data.KeyPIR_num==0xFF){BspBrfRfEsb_s_data.KeyPIR_num=0;}else{BspBrfRfEsb_s_data.KeyPIR_num++;}BspBrfRfEsb_s_data.flag_trigger=1;
#define		BSP_PWR_CMD_TIMER_FUN1	if(BspBrfRfEsb_s_data.Num==0xFF){BspBrfRfEsb_s_data.Num=0;}else{BspBrfRfEsb_s_data.Num++;}BspBrfRfEsb_s_data.sum=Count_Sum(0, (uint8_t *)&BspBrfRfEsb_s_data,20);Bsp_NrfRfEsb_Tx((uint8_t*)&BspBrfRfEsb_s_data,21);
#endif
#endif
//-------------------接口宏定义(硬件相关)--------------------
//-------------------接口宏定义(硬件无关)--------------------
