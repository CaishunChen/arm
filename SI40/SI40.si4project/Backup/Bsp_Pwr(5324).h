...
#define 	BSP_PWR_CMD_KEY1_FUN1	if(BspBrfRfEsb_s_data.Key1_num==0xFF){BspBrfRfEsb_s_data.Key1_num=0;}else{BspBrfRfEsb_s_data.Key1_num++;}
#define 	BSP_PWR_CMD_KEY2_FUN1	if(BspBrfRfEsb_s_data.Key2_num==0xFF){BspBrfRfEsb_s_data.Key2_num=0;}else{BspBrfRfEsb_s_data.Key2_num++;}
#define 	BSP_PWR_CMD_KEY3_FUN1	if(BspBrfRfEsb_s_data.Key3_num==0xFF){BspBrfRfEsb_s_data.Key3_num=0;}else{BspBrfRfEsb_s_data.Key3_num++;}
#define 	BSP_PWR_CMD_KEY4_FUN1	if(BspBrfRfEsb_s_data.Key4_num==0xFF){BspBrfRfEsb_s_data.Key4_num=0;}else{BspBrfRfEsb_s_data.Key4_num++;}
#define 	BSP_PWR_CMD_KEY5_FUN1	if(BspBrfRfEsb_s_data.KeyPIR_num==0xFF){BspBrfRfEsb_s_data.KeyPIR_num=0;}else{BspBrfRfEsb_s_data.KeyPIR_num++;}
