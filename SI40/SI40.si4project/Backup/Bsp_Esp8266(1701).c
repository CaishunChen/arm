...
uint8_t BspEsp8266_Tx(BSP_ESP8266_E_CH ch,uint8_t *pbuf,uint16_t len)
{
    ...
    switch(ch)
    {
        case BSP_ESP8266_E_CH_1:
            if(BspEsp8266_s_Info.Flag_Connect_1==0)
            {
                return ERR;
            }
            break;
        case BSP_ESP8266_E_CH_2:
            if(BspEsp8266_s_Info.Flag_Connect_2==0)
            {
                return ERR;
            }
            break;
        case BSP_ESP8266_E_CH_3:
            if(BspEsp8266_s_Info.Flag_Connect_3==0)
            {
                return ERR;
            }
            break;
        case BSP_ESP8266_E_CH_4:
            if(BspEsp8266_s_Info.Flag_Connect_4==0)
            {
                return ERR;
            }
            break;
        case BSP_ESP8266_E_CH_5:
            if(BspEsp8266_s_Info.Flag_Connect_5==0)
            {
                return ERR;
            }
            break;
    ...
    switch(BspEsp8266_s_Tx.AtCmd)
    {
        ...
        case AT_RST:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
				...
				BspEsp8266_s_Info.Flag_Connect_1=0;
				BspEsp8266_s_Info.Flag_Connect_2=0;
				BspEsp8266_s_Info.Flag_Connect_3=0;
				BspEsp8266_s_Info.Flag_Connect_4=0;
				BspEsp8266_s_Info.Flag_Connect_5=0;
            }
            // 处理超时
        ...
        case AT_CIPSTART5:
            ...
            if(BspEsp8266_s_Rx.len!=0)
            {
                ...
                if(p)
                {
                    ...
                    {
                        case BSP_ESP8266_E_CH_1:
                            BspEsp8266_s_Info.Flag_Connect_1=1;
                            break;
                        case BSP_ESP8266_E_CH_2:
                            BspEsp8266_s_Info.Flag_Connect_2=1;
                            break;
                        case BSP_ESP8266_E_CH_3:
                            BspEsp8266_s_Info.Flag_Connect_3=1;
                            break;
                        case BSP_ESP8266_E_CH_4:
                            BspEsp8266_s_Info.Flag_Connect_4=1;
                            break;
                        case BSP_ESP8266_E_CH_5:
                            BspEsp8266_s_Info.Flag_Connect_5=1;
                            break;
                        default:
                            break;
                    }
