...
#define MAX_ALLCODEWORD    3706              //P14,P35 数据容量[码字]* (E) (VER:40), 所有码字为8位
#define MAX_DATACODEWORD   2956              //P27     最大信息码子(Ver：40-L)，所有码字为8位
#define MAX_CODEBLOCK      153               //最大纠错码字 Ver：36.37.38_L_第二块
#define MAX_MODULESIZE     (21+(QR_VER-1)*4) //P14 每边的模块数(A)
