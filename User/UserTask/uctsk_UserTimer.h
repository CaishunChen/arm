...
#define  USER_TIMER_100MS_CH6 BspRtc_1000ms()
#if   (defined(XKAP_ICARE_B_D_M))
#define  USER_TIMER_100MS_CH7 BSP_LED_LED1_TOGGLE
#endif
#if		(HARDWARE_VER==0xF1)
#include "Bsp_Esp8266.h"
#define  USER_TIMER_100MS_CH8 BspEsp8266_100ms()
#endif
...
extern void Module_Memory_100ms(void);
...
#define  USER_TIMER_100MS_CH6 Module_Memory_100ms();
#if	(HARDWARE_SUB_VER==3)
#include "Bsp_Esp8266.h"
#define  USER_TIMER_100MS_CH7 BspEsp8266_100ms()
#endif
...
#define  USER_TIMER_100MS_CH2 	Hci_100ms()
#define  USER_TIMER_100MS_CH3 	Key_Main_DebugTest_100ms()
#define  USER_TIMER_100MS_CH4 	BspBmp180_DebugTest_100ms()
#define  USER_TIMER_100MS_CH5 	BspAp3216c_DebugTest_100ms()
#define  USER_TIMER_100MS_CH6 	BspHx711_100ms()
#define  USER_TIMER_100MS_CH7 	BspHs0038_100ms()
#define  USER_TIMER_100MS_CH8 	BspDhtXX_100ms()
#define  USER_TIMER_100MS_CH9 	BspMpu6050_DebugTest_100ms()
#if		(SOFTWARE_VER==0)
#define  USER_TIMER_100MS_CH10 	BspEsp8266_100ms()
#endif

//#define  USER_TIMER_100MS_CH9 BspNrfBle_Timer(100)
