...
#define GPRS_TX_MEM_SIZE      E_MEM_MANAGER_TYPE_256B
#define GPRS_INIT_ON_OFF      ON
#define GPRS_NET_TEST_CH	  0
#define GPRS_NET_TEST_ORDER	  GPRSNET_E_CONNECT_ORDER_UDP_IP
#define GPRS_NET_TEST_DNS     "10.10.18.202"
#define GPRS_NET_TEST_PORT    "8080"
#else
