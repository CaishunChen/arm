...
#define HCI_KEY_SOS_2A4	BSP_KEY_E_KEY_2A4
#define HCI_SW1_PIN		29
#define HCI_SW2_PIN		30
#elif (defined(TEST_NRF52_V1))
#define HCI_KEY_ENTER   BSP_KEY_E_KEY1
#define HCI_KEY_UP   	BSP_KEY_E_KEY3
#define HCI_KEY_DOWN   	BSP_KEY_E_KEY2
#define HCI_KEY_LEFT   	BSP_KEY_E_KEY5
#define HCI_KEY_RIGHT   BSP_KEY_E_KEY4
...
#elif (defined(XKAP_ICARE_A_M)||defined(XKAP_ICARE_A_S)||defined(XKAP_ICARE_A_C))
#elif (defined(XKAP_ICARE_B_M))
extern void Hci_GetWeight30s(uint8_t* pbuf);
extern void Hci_GetSW(uint8_t* pbuf);
