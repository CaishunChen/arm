...
#else
	pi8=MemManager_Get(E_MEM_MANAGER_TYPE_1KB);
#endif
    //复制数据
        ...
        case IAP_APP_CMD_DATA:
            ...
            switch(step)
            {
                ...
                case IAP_APP_STEP_START:
                    ...
                    Iap_Ver            =  Ver;
                    //申请缓存
#if		(IAP_MAX_BYTE==(256*1024L))
					Iap_pStateBitmapbuf   =  MemManager_Get(E_MEM_MANAGER_TYPE_256B);
#elif	(IAP_MAX_BYTE==(1024*1024L))
                ...
                case IAP_APP_STEP_UPGRADE:
                    //释放缓存
#if		(IAP_MAX_BYTE==(256*1024L))
					MemManager_Free(E_MEM_MANAGER_TYPE_256B,Iap_pStateBitmapbuf);
#elif	(IAP_MAX_BYTE==(1024*1024L))
...
#else
	MemManager_Free(E_MEM_MANAGER_TYPE_1KB,pi8);
#endif
    //
    return res;
}
