...
#define  BSP_PWR_CMD_KEY_NUM_5         4
// BMP180
...
#define  BSP_PWR_CMD_ENABLE
#define		BSP_PWR_INIT			static uint8_t s_tx_num=0;static uint16_t s_timer_num=0;
#define 	BSP_PWR_CMD_KEY1_FUN1	if(BspBrfRfEsb_s_data.Key1_num==0xFF){BspBrfRfEsb_s_data.Key1_num=0;}else{BspBrfRfEsb_s_data.Key1_num++;}BspBrfRfEsb_s_data.flag_trigger=1;s_tx_num=10;
#define 	BSP_PWR_CMD_KEY2_FUN1	if(BspBrfRfEsb_s_data.Key2_num==0xFF){BspBrfRfEsb_s_data.Key2_num=0;}else{BspBrfRfEsb_s_data.Key2_num++;}BspBrfRfEsb_s_data.flag_trigger=1;s_tx_num=10;
#define 	BSP_PWR_CMD_KEY3_FUN1	if(BspBrfRfEsb_s_data.Key3_num==0xFF){BspBrfRfEsb_s_data.Key3_num=0;}else{BspBrfRfEsb_s_data.Key3_num++;}BspBrfRfEsb_s_data.flag_trigger=1;s_tx_num=10;
#define 	BSP_PWR_CMD_KEY4_FUN1	if(BspBrfRfEsb_s_data.Key4_num==0xFF){BspBrfRfEsb_s_data.Key4_num=0;}else{BspBrfRfEsb_s_data.Key4_num++;}BspBrfRfEsb_s_data.flag_trigger=1;s_tx_num=10;
#define 	BSP_PWR_CMD_KEY5_FUN1	if(s_tx_num==0){if(BspBrfRfEsb_s_data.KeyPIR_num==0xFF){BspBrfRfEsb_s_data.KeyPIR_num=0;}else{BspBrfRfEsb_s_data.KeyPIR_num++;}BspBrfRfEsb_s_data.flag_trigger=1;s_tx_num=1;}
#define		BSP_PWR_CMD_TIMER_FUN1	if((s_tx_num!=0)||((s_timer_num++)>15*60)){s_timer_num=0;if(s_tx_num!=0){s_tx_num--;}if(BspBrfRfEsb_s_data.Num==0xFF){BspBrfRfEsb_s_data.Num=0;}else{BspBrfRfEsb_s_data.Num++;}BspBrfRfEsb_s_data.sum=Count_Sum(0, (uint8_t *)&BspBrfRfEsb_s_data,20);Bsp_NrfRfEsb_Tx((uint8_t*)&BspBrfRfEsb_s_data,21);}
#endif
#endif
//-------------------接口宏定义(硬件相关)--------------------
//-------------------接口宏定义(硬件无关)--------------------
