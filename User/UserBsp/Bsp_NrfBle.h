...
#endif
#define  BSP_NRFBLE_ENABLE_TIMER_1MS
#define  BSP_NRFBLE_TIMER_1MS_CH1         BspHBridge_1ms();
#define  BSP_NRFBLE_TIMER_1MS_CH2         BspStepperMotor_1ms();
#define  BSP_NRFBLE_TIMER_1MS_CH3         ulHighFrequencyTimerTicks+=20
#define  BSP_NRFBLE_TIMER_1MS_CH4         UART_1ms_IRQ();
#define  BSP_NRFBLE_TIMER_1MS_CH5         SdFat_1msPro()
...
#define  BSP_NRFBLE_TXPOWER               4
#define  BSP_NRFBLE_ENABLE_TIMER_1MS
#define  BSP_NRFBLE_TIMER_1MS_CH1   	ulHighFrequencyTimerTicks+=20      
/*
#define  BSP_NRFBLE_ENABLE_TIMER_10MS
#define  BSP_NRFBLE_TIMER_10MS_CH1        
*/
