...
#define BSP_TWI_SDA_PIN             18
#define BSP_TWI_SCL_PIN             16
#endif
#define BSP_TWI_X                   1	/*0-1*/
//<----
...
#define BSP_TWI_MODE_HARDWARE
#define BSP_TWI_MUTEX_DISABLE
#define BSP_TWI_SDA_PIN             19
#define BSP_TWI_SCL_PIN             17
#define BSP_TWI_X                   1	/*0-1*/
//<----
...
#endif
//
#if		(defined(BSP_TWI_MODE_HARDWARE)&&defined(BSP_TWI_MODE_SOFTWARE))
#error Please Set Mode to Bsp_Twi.h
#endif
//-------------------接口宏定义(硬件无关)--------------------
