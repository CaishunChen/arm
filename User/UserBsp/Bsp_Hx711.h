...
//<----
#elif (defined(XKAP_ICARE_A_M)||defined(XKAP_ICARE_A_S)||defined(XKAP_ICARE_A_C))
//---->
...
#define BSP_HX711_DOUT_PIN    27
#define BSP_HX711_SCLK_PIN    28
#endif
//<----
#elif	(defined(TEST_NRF52_V1))
//---->
#define BSP_HX711_DOUT_PIN    31
#define BSP_HX711_SCLK_PIN    3
//<----
#else 
...
#define BSP_HX711_REF_VALUE  (0.15075)
#else
...
extern uint8_t BspHx711_Get_ad(uint32_t *pvalue_ad,uint8_t num);
extern uint8_t BspHx711_Get_g(uint32_t *pvalue_g,uint32_t *pvalue_ad);
