...
static uint8_t BspEsp8266_DebugInfoPrint_Enable =   OFF;
/* Extern variables ----------------------------------------------------------*/
...
void BspEsp8266_Init(void)
{
    ...
    BspEsp8266_s_Info.Flag_OnOff    	=   ON;
    BspEsp8266_s_Info.Flag_WordMode 	=   BSP_ESP8266_E_WORKMODE_NORMAL;
...
{
    // 未连上服务器
    if(ch<BSP_ESP8266_E_CH_MAX)
    {
        if(BspEsp8266_s_Info.ConnectStateBuf[ch]==0)
        {
            return ERR;
        }
    }
    ...
    BspEsp8266_s_Info.TxNumBuf[ch-BSP_ESP8266_E_CH_1]++;
...
void BspEsp8266_WorkMode(BSP_ESP8266_E_WORKMODE mode)
{
    switch(mode)
    {
        case BSP_ESP8266_E_WORKMODE_NORMAL:
            if(BspEsp8266_s_Info.Flag_WordMode  ==  BSP_ESP8266_E_WORKMODE_NORMAL)
            {
                break;
            }
            BspEsp8266_s_Info.Flag_WordMode =   BSP_ESP8266_E_WORKMODE_NORMAL;
            BspEsp8266_s_Info.Flag_ModeSet  =   1;
            BspEsp8266_s_Tx.AtCmd           =   AT_RST;
            BspEsp8266_s_Tx.Flag_state      =   0;
            break;
        case BSP_ESP8266_E_WORKMODE_SET:
            if(BspEsp8266_s_Info.Flag_WordMode  ==  BSP_ESP8266_E_WORKMODE_SET)
            {
                break;
            }
            BspEsp8266_s_Info.Flag_WordMode =   BSP_ESP8266_E_WORKMODE_SET;
            BspEsp8266_s_Info.Flag_ModeSet  =   1;
            BspEsp8266_s_Tx.AtCmd           =   AT_RESTORE;
            BspEsp8266_s_Tx.Flag_state      =   0;
            break;
        default:
            break;
...
void BspEsp8266_100ms(void)
{
    ...
    //UART_DMA_Tx(BSP_ESP8266_UARTX,"0123456789",10);
#endif
    ...
    if(BspEsp8266_s_Rx.len!=0)
    {
        BspEsp8266_s_Rx.buf[BspEsp8266_s_Rx.len]=0;
        //已通过手机设置连接wifi
        ...
        else if(strstr((const char *)BspEsp8266_s_Rx.buf,"WIFI GOT IP"))
        {
            BspEsp8266_s_Tx.Flag_state  =   0;
            BspEsp8266_s_Tx.AtCmd       =   AT_CIFSR;
        ...
        //已连接到路由
        else if(strstr((const char *)BspEsp8266_s_Rx.buf,"WIFI CONNECTED"))
        {
            BspEsp8266_s_Rx.len         =   0;
			BspEsp8266_s_Info.Flag_ConnectAP	=	1;
			BspEsp8266_s_Info.Flag_WordMode		=	BSP_ESP8266_E_WORKMODE_NORMAL;
        }
		//断开连接到路由
        else if(strstr((const char *)BspEsp8266_s_Rx.buf,"WIFI DISCONNECT"))
        {
			BspEsp8266_s_Info.Flag_ConnectAP	=	0;
        }
        //接收到数据
        else if(strstr((const char *)BspEsp8266_s_Rx.buf,"+IPD,"))
        {
            ...
            switch (i)
            {
                ...
                case 0:
                    BSP_ESP8266_RX_PARSE_CH1(p1,i16);
                    BspEsp8266_s_Info.RxNumBuf[i]++;
                    BspEsp8266_s_Rx.len =   0;
                    break;
#endif
#ifdef  BSP_ESP8266_RX_PARSE_CH2
                case 1:
                    BSP_ESP8266_RX_PARSE_CH2(p1,i16);
                    BspEsp8266_s_Info.RxNumBuf[i]++;
                    BspEsp8266_s_Rx.len =   0;
                    break;
#endif
                ...
                case 2:
                    BSP_ESP8266_RX_PARSE_CH3(p1,i16);
                    BspEsp8266_s_Info.RxNumBuf[i]++;
                    BspEsp8266_s_Rx.len =   0;
                    break;
#endif
                ...
                case 3:
                    BSP_ESP8266_RX_PARSE_CH4(p1,i16);
                    BspEsp8266_s_Info.RxNumBuf[i]++;
                    BspEsp8266_s_Rx.len =   0;
                    break;
#endif
#ifdef  BSP_ESP8266_RX_PARSE_CH5
                case 4:
                    BSP_ESP8266_RX_PARSE_CH5(p1,i16);
                    BspEsp8266_s_Info.RxNumBuf[i]++;
                    BspEsp8266_s_Rx.len =   0;
                    break;
#endif
    ...
    switch(BspEsp8266_s_Tx.AtCmd)
    {
        ...
        case AT_RST:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
                ...
                //
                memset((char*)&BspEsp8266_s_Info.LotalIP_AP    ,   0   ,   sizeof(BspEsp8266_s_Info.LotalIP_AP));
                memset((char*)&BspEsp8266_s_Info.LotalIP_STA   ,   0   ,   sizeof(BspEsp8266_s_Info.LotalIP_STA));
                memset((char*)&BspEsp8266_s_Info.ConnectStateBuf    ,   0   ,   sizeof(BspEsp8266_s_Info.ConnectStateBuf));
            }
            // 处理超时
            if(BspEsp8266_s_Tx.cmt>=100 || BspEsp8266_s_Info.Flag_ModeSet==1)
            {
        ...
        case ATE:
            ...
            */
            ...
            case CIPSTATUS:
                ...
                break;
            */
#if     (BSP_ESP8266_AUTO_CONNECT_ENABLE==1)
        //配置wifi工作模式
        case AT_CWMODE:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
                BspEsp8266_s_Tx.Flag_state   =   1;
                BspEsp8266_s_Tx.cmt     =   0;
                strcpy(BspEsp8266_s_Tx.buf,"AT+CWMODE_DEF=1\r\n");
                BspEsp8266_s_Tx.len=strlen(BspEsp8266_s_Tx.buf);
            }
            if(BspEsp8266_s_Rx.len!=0)
            {
        ...
        case AT_CWAUTOCONN:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
                BspEsp8266_s_Tx.Flag_state   =   1;
                BspEsp8266_s_Tx.cmt     =   0;
                strcpy(BspEsp8266_s_Tx.buf,"AT+CWAUTOCONN=1\r\n");
                BspEsp8266_s_Tx.len=strlen(BspEsp8266_s_Tx.buf);
            }
            if(BspEsp8266_s_Rx.len!=0)
            {
        ...
        case AT_CWSTARTSMART:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
                BspEsp8266_s_Tx.Flag_state   =   1;
                BspEsp8266_s_Tx.cmt     =   0;
                strcpy(BspEsp8266_s_Tx.buf,"AT+CWSTARTSMART=3\r\n");
                BspEsp8266_s_Tx.len=strlen(BspEsp8266_s_Tx.buf);
            }
            if(BspEsp8266_s_Rx.len!=0)
            {
                ...
                {
                    /*
                    if(strstr((const char *)BspEsp8266_s_Rx.buf,"WIFI DISCONNECT"))
                    {
                        BspEsp8266_s_Tx.Flag_state   =   0;
                        BspEsp8266_s_Tx.AtCmd   =   AT_RST;
                        BspEsp8266_s_Tx.cmt     =   0;
        ...
        case AT_WAITFORCONFIG:
            if(BspEsp8266_s_Rx.len!=0)
            {
                ...
                if(strstr((const char *)BspEsp8266_s_Rx.buf,"smartconfig connected wifi"))
                {
                    BspEsp8266_s_Tx.Flag_state      =   0;
                    BspEsp8266_s_Tx.AtCmd           =   AT_RST;
                    BspEsp8266_s_Info.Flag_ModeSet  =   0;
                    BspEsp8266_s_Info.Flag_WordMode =   BSP_ESP8266_E_WORKMODE_NORMAL;
                }
                BspEsp8266_s_Rx.len =   0;
            }
            // 处理超时
            if(BspEsp8266_s_Tx.cmt>=200)
            {
                BspEsp8266_s_Tx.AtCmd   =   AT_WAITFORCONFIG;
                BspEsp8266_s_Tx.Flag_state   =   0;
                BspEsp8266_s_Tx.cmt     =   0;
        ...
        case AT_CWMODE:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
                BspEsp8266_s_Tx.Flag_state   =   1;
                BspEsp8266_s_Tx.cmt     =   0;
                strcpy(BspEsp8266_s_Tx.buf,"AT+CWMODE_CUR=3\r\n");
                BspEsp8266_s_Tx.len=strlen(BspEsp8266_s_Tx.buf);
            }
            if(BspEsp8266_s_Rx.len!=0)
            {
        ...
        case AT_CWJAP:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
                BspEsp8266_s_Tx.Flag_state   =   1;
                BspEsp8266_s_Tx.cmt     =   0;
                strcpy(BspEsp8266_s_Tx.buf,BSP_ESP8266_WIFI_STA_PW_STR);
                BspEsp8266_s_Tx.len=strlen(BspEsp8266_s_Tx.buf);
            }
            if(BspEsp8266_s_Rx.len!=0)
            {
        ...
        case AT_CIFSR:
            ...
            if(BspEsp8266_s_Rx.len!=0)
            {
                ...
                if(/*BspEsp8266_s_Info.LotalIP_AP[0]!=0\
                   ...
                   ||*/BspEsp8266_s_Info.LotalIP_STA[0]!=0\
                    ||BspEsp8266_s_Info.LotalIP_STA[1]!=0\
                    ||BspEsp8266_s_Info.LotalIP_STA[2]!=0\
                    ||BspEsp8266_s_Info.LotalIP_STA[3]!=0)
                {
                    BspEsp8266_s_Tx.Flag_state   =   0;
                ...
                {
#if     (BSP_ESP8266_AUTO_CONNECT_ENABLE==1)
                    if((BspEsp8266_s_Tx.ch++)>2)
                    {
                        BspEsp8266_s_Tx.ch          =   0;
                        BspEsp8266_s_Tx.Flag_state  =   0;
                        BspEsp8266_s_Tx.AtCmd       =   AT_RST;
                    }
#else
        ...
        case AT_CIPSTART5:
            ...
            if(BspEsp8266_s_Rx.len!=0)
            {
                ...
                if(p)
                {
                    ...
                    i=*p;
                    i=i-'0';
                    if(i<BSP_ESP8266_E_CH_MAX)
                    {
                        BspEsp8266_s_Info.ConnectStateBuf[i]=1;
                    }
                    BspEsp8266_s_Tx.Flag_state   =   0;
                    // 不知原因第一包数据发送不好使,所以在此发送一包
                    BspEsp8266_Tx((BSP_ESP8266_E_CH)i,"connect",strlen("connect"));
                }
                //
                ...
                if(p)
                {
                    if(BspEsp8266_s_Tx.AtCmd==AT_CIPSTART1)
                    {
                        BspEsp8266_s_Info.ConnectStateBuf[0]=1;
                    }
                    else if(BspEsp8266_s_Tx.AtCmd==AT_CIPSTART2)
                    {
                        BspEsp8266_s_Info.ConnectStateBuf[1]=1;
                    }
                    else if(BspEsp8266_s_Tx.AtCmd==AT_CIPSTART3)
                    {
                        BspEsp8266_s_Info.ConnectStateBuf[2]=1;
                    }
                    else if(BspEsp8266_s_Tx.AtCmd==AT_CIPSTART4)
                    {
                        BspEsp8266_s_Info.ConnectStateBuf[3]=1;
                    }
                    else if(BspEsp8266_s_Tx.AtCmd==AT_CIPSTART5)
                    {
                        BspEsp8266_s_Info.ConnectStateBuf[4]=1;
                    }
                    BspEsp8266_s_Tx.Flag_state   =   0;
                }
                //
        ...
        case AT_CIPSEND:
            ...
            if(BspEsp8266_s_Rx.len!=0)
            {
                ...
                else if(strstr((const char *)BspEsp8266_s_Rx.buf,"ERROR"))
                {
                    BspEsp8266_s_Tx.AtCmd   =   AT;
                    BspEsp8266_s_Tx.Flag_state   =   0;
                    if(BspEsp8266_s_Tx.ch<BSP_ESP8266_E_CH_MAX)
                    {
                        BspEsp8266_s_Info.ConnectStateBuf[BspEsp8266_s_Tx.ch]=0;
                    }
                }
                BspEsp8266_s_Rx.len =   0;
            }
...
//      AT_GMR,             //查询版本信息
        ...
        case AT_CWJAP_SEE:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
                BspEsp8266_s_Tx.Flag_state   =   1;
                BspEsp8266_s_Tx.cmt     =   0;
                strcpy(BspEsp8266_s_Tx.buf,"AT+CWJAP?\r\n");
                BspEsp8266_s_Tx.len=strlen(BspEsp8266_s_Tx.buf);
            }
            if(BspEsp8266_s_Rx.len!=0)
            {
                //
                p=strstr((const char *)BspEsp8266_s_Rx.buf,"+CWJAP:");
                if(p!=NULL)
                {
                    BspEsp8266_s_Tx.Flag_state   =   0;
                    BspEsp8266_s_Tx.AtCmd   =   IDLE;
        ...
        case AT_RESTORE:
            if(BspEsp8266_s_Tx.Flag_state    ==  0)
            {
                BspEsp8266_s_Tx.Flag_state   =   1;
                BspEsp8266_s_Tx.cmt     =   0;
                strcpy(BspEsp8266_s_Tx.buf,"AT+RESTORE\r\n");
                BspEsp8266_s_Tx.len=strlen(BspEsp8266_s_Tx.buf);
            }
            // 处理超时
            if(BspEsp8266_s_Tx.cmt>=30)
            {
                BspEsp8266_s_Tx.AtCmd       =   AT_RST;
                BspEsp8266_s_Tx.Flag_state  =   0;
            }
...
static void BspEsp8266_Test_100ms(void)
{
    ...
    scmt++;
#if BSP_ESP8266_TEST_TX_ENABLE==1
    if(scmt%50==0)
    {
        BspEsp8266_Tx(BSP_ESP8266_E_CH_1,"XSL-WIFI-TEST-SEND\r\n",strlen("XSL-WIFI-TEST-SEND\r\n"));
    }
#endif
    if(scmt%20==0 && BspEsp8266_DebugInfoPrint_Enable==1)
    {
        pbuf=MemManager_Get(E_MEM_MANAGER_TYPE_256B);
        sprintf((char*)pbuf,"----------RTC: %04d-%02d-%02d %02d:%02d:%02d\r\n"\
        ...
        for(pbuf[200]=0; pbuf[200]<BSP_ESP8266_E_CH_MAX; pbuf[200]++)
        {
            sprintf((char*)pbuf,"CH%d: ConnectStateBuf-%d TxNumBuf-%09ld RxNumBuf-%09ld\r\n"\
                    ,pbuf[200]\
                    ,BspEsp8266_s_Info.ConnectStateBuf[pbuf[200]]\
                    ,BspEsp8266_s_Info.TxNumBuf[pbuf[200]]\
                    ,BspEsp8266_s_Info.RxNumBuf[pbuf[200]]);
            DebugOutStr((int8_t*)pbuf);
            MODULE_OS_DELAY_MS(1);
        }
        sprintf((char*)pbuf,"LotalIP_AP :[%02X][%02X][%02X][%02X]\r\nLotalIP_STA:[%02X][%02X][%02X][%02X]\r\nMacAddr_AP :[%02X][%02X][%02X][%02X][%02X][%02X]\r\nMacAddr_STA:[%02X][%02X][%02X][%02X][%02X][%02X]\r\n"\
                ,BspEsp8266_s_Info.LotalIP_AP[0]\
                ,BspEsp8266_s_Info.LotalIP_AP[1]\
                ,BspEsp8266_s_Info.LotalIP_AP[2]\
                ,BspEsp8266_s_Info.LotalIP_AP[3]\
                ,BspEsp8266_s_Info.LotalIP_STA[0]\
                ,BspEsp8266_s_Info.LotalIP_STA[1]\
                ,BspEsp8266_s_Info.LotalIP_STA[2]\
                ,BspEsp8266_s_Info.LotalIP_STA[3]\
                ,BspEsp8266_s_Info.MacAddr_AP[0]\
                ,BspEsp8266_s_Info.MacAddr_AP[1]\
                ,BspEsp8266_s_Info.MacAddr_AP[2]\
                ,BspEsp8266_s_Info.MacAddr_AP[3]\
                ,BspEsp8266_s_Info.MacAddr_AP[4]\
                ,BspEsp8266_s_Info.MacAddr_AP[5]\
                ,BspEsp8266_s_Info.MacAddr_STA[0]\
                ,BspEsp8266_s_Info.MacAddr_STA[1]\
                ,BspEsp8266_s_Info.MacAddr_STA[2]\
                ,BspEsp8266_s_Info.MacAddr_STA[3]\
                ,BspEsp8266_s_Info.MacAddr_STA[4]\
                ,BspEsp8266_s_Info.MacAddr_STA[5]);
        DebugOutStr((int8_t*)pbuf);
        sprintf((char*)pbuf,"SignalVal    : %d\r\nFlag_Install : %d\r\nFlag_OnOff   : %d\r\nFlag_ModeSet : %d\r\nFlag_WordMode: %d\r\n"\
                ,BspEsp8266_s_Info.SignalVal\
                ,BspEsp8266_s_Info.Flag_Install\
                ,BspEsp8266_s_Info.Flag_OnOff\
                ,BspEsp8266_s_Info.Flag_ModeSet\
                ,BspEsp8266_s_Info.Flag_WordMode\
               );
        DebugOutStr((int8_t*)pbuf);
...
void BspEsp8266_DebugInfoPrintOnOff(uint8_t OnOff)
{
    if(OnOff==ON)
    {
        BspEsp8266_DebugInfoPrint_Enable=1;
    }
    else
    {
        BspEsp8266_DebugInfoPrint_Enable=0;
    }
}
