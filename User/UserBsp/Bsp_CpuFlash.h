...
#if   (defined(STM32F1))
//---->
#define	 BSP_CPU_MODEL_STR					"STM32F1"
#define  BSP_CPU_FLASH_SIZE                 (1*512*1024)
#define  BSP_CPU_FLASH_BASE_ADDR            (0x08000000)
#define  BSP_CPU_FLASH_BOOT_ADDR			BSP_CPU_FLASH_BASE_ADDR
#define  BSP_CPU_FLASH_BOOT_ADDR_END		(0x08004000-1)
...
#define  BSP_CPU_FLASH_APP_ADDR_END			(BSP_CPU_FLASH_APP_BACKUP_ADDR-1)
...
#define  BSP_CPU_FLASH_APP_BACKUP_ADDR_END	BSP_CPU_FLASH_END_ADDR
...
//---->
#define	 BSP_CPU_MODEL_STR					"STM32F4"
#define BSP_CPU_FLASH_SIZE                  (1*512*1024)
#define  BSP_CPU_FLASH_BASE_ADDR            (0x08000000)
#define  BSP_CPU_FLASH_BOOT_ADDR			BSP_CPU_FLASH_BASE_ADDR
#define  BSP_CPU_FLASH_BOOT_ADDR_END		(0x08004000-1)
...
#elif (defined(NRF51))
//---->
#define	 BSP_CPU_MODEL_STR					"NRF51"
#define  BSP_CPU_FLASH_SIZE                 ((NRF_FICR->CODESIZE)*(NRF_FICR->CODEPAGESIZE))
#define  BSP_CPU_FLASH_BASE_ADDR            0
#define  BSP_CPU_FLASH_BOOT_ADDR			(0x0003AC00)
#define  BSP_CPU_FLASH_BOOT_ADDR_END		(0x0003FC00-1)
#define  BSP_CPU_FLASH_PARA_ADDR            (0x0003AC00-((NRF_FICR->CODEPAGESIZE)))
#define  BSP_CPU_FLASH_PARA_ADDR_END        (0x0003AC00-1)
#define  BSP_CPU_FLASH_PARA_BACKUP_ADDR     (0x0003AC00-(2*(NRF_FICR->CODEPAGESIZE)))
#define  BSP_CPU_FLASH_PARA_BACKUP_ADDR_END (0x0003AC00-((NRF_FICR->CODEPAGESIZE))-1)
#define  BSP_CPU_FLASH_APP_ADDR             (0x0001B000)
#define  BSP_CPU_FLASH_APP_ADDR_END			(0x0003AC00-(2*(NRF_FICR->CODEPAGESIZE))-1)
#define  BSP_CPU_FLASH_APP_BACKUP_ADDR      (0x0001B000)
#define  BSP_CPU_FLASH_APP_BACKUP_ADDR_END	(0x0003AC00-(2*(NRF_FICR->CODEPAGESIZE))-1)
#define  BSP_CPU_FLASH_END_ADDR             (BSP_CPU_FLASH_BASE_ADDR+BSP_CPU_FLASH_SIZE-1)
//中断向量
...
#elif (defined(NRF52))
//---->
#define	 BSP_CPU_MODEL_STR					"NRF52"
#define  BSP_CPU_FLASH_SIZE                 ((NRF_FICR->CODESIZE)*(NRF_FICR->CODEPAGESIZE))
#define  BSP_CPU_FLASH_BASE_ADDR            0
#define  BSP_CPU_FLASH_BOOT_ADDR			(0x00078000)
#define  BSP_CPU_FLASH_BOOT_ADDR_END		(0x0007E000-1)
#define  BSP_CPU_FLASH_PARA_ADDR            (0x00078000-((NRF_FICR->CODEPAGESIZE)))
#define  BSP_CPU_FLASH_PARA_ADDR_END        (0x00078000-1)
#define  BSP_CPU_FLASH_PARA_BACKUP_ADDR     (0x00078000-(2*(NRF_FICR->CODEPAGESIZE)))
#define  BSP_CPU_FLASH_PARA_BACKUP_ADDR_END (0x00078000-((NRF_FICR->CODEPAGESIZE))-1)
#define  BSP_CPU_FLASH_APP_ADDR             (0x0001F000)
#define  BSP_CPU_FLASH_APP_ADDR_END			(0x00078000-(2*(NRF_FICR->CODEPAGESIZE))-1)
#define  BSP_CPU_FLASH_APP_BACKUP_ADDR      (0x0001F000)
#define  BSP_CPU_FLASH_APP_BACKUP_ADDR_END	(0x00078000-(2*(NRF_FICR->CODEPAGESIZE))-1)
#define  BSP_CPU_FLASH_END_ADDR             (BSP_CPU_FLASH_BASE_ADDR+BSP_CPU_FLASH_SIZE-1)
//中断向量
#define  BSP_CPU_FLASH_SET_VECTOR_TABLE
...
//<----
#else 
#error Please Set Project to Bsp_CpuFlash.h
#endif
//-------------------接口宏定义(硬件无关)--------------------
