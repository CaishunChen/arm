...
#include "LCD_RA8875.h"
#include "fonts.h"
#define	BSP_TFT_LCD_FSMC_ENABLE
#define BSP_TFT_LCD_BACKLIGHT_ENABLE
#else
#error Please Set Project to bsp_tft_lcd.h
#endif


/* 定义LCD显示区域的分辨率 */
#define LCD_28_HEIGHT   240     /* 2.8寸宽屏 高度，单位：像素 */
#define LCD_28_WIDTH    320     /* 2.8寸宽屏 高度，单位：像素 */

#define LCD_30_HEIGHT   240     /* 3.0寸宽屏 高度，单位：像素 */
#define LCD_30_WIDTH    400     /* 3.0寸宽屏 宽度，单位：像素 */

#define LCD_35_HEIGHT   320     /* 3.5寸宽屏 高度，单位：像素 */
#define LCD_35_WIDTH    480     /* 3.5寸宽屏 宽度，单位：像素 */
...
enum
{
    ...
    CL_THI_XXTO55   = RGB( 154,  204,  255),
    CL_THI_55TO60   = RGB( 0  ,  255,  255),
    CL_THI_60TO65   = RGB( 204,  255,  255),
    CL_THI_65TO70   = RGB( 204,  255,  204),
    CL_THI_70TO75   = RGB( 255,  255,  154),
    CL_THI_75TO80   = RGB( 255,  204,  154),
    CL_THI_80TO85   = RGB( 255,  204,  0  ),
    CL_THI_85TOXX   = RGB( 255,  0  ,  0  ),
...
typedef enum
{
    ...
    FC_ST_24,           /* XSL 仅添加部分ASCII字库 */
    FC_ST_32,           /* XSL 仅添加部分ASCII字库 */
    FC_ST_64,           /* XSL 仅添加部分ASCII字库 */
	  FC_ST_B_72,         /* XSL 仅添加部分ASCII字库 */
} FONT_CODE_E;
