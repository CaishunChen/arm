...
#include "Bsp_Esp8266.h"
#define UART1_TX_PIN                19/*20*/
#define UART1_RX_PIN                20/*19*/
#define UART1_RX_OVERTIME_MS        100
#define UART1_DMA_RX_PARSE_PRO      BspEsp8266_InterruptRx
#endif
//
...
//
#elif (defined(XKAP_ICARE_A_S)||defined(XKAP_ICARE_A_C)||defined(BASE_NRF51)||defined(BASE_NRF52))
#include "uctsk_Debug.h"
#define UART1_TX_BUF_SIZE           256
#define UART1_RX_BUF_SIZE           256
#define UART1_TX_PIN                30
