...
static nrf_drv_timer_t timer = NRF_DRV_TIMER_INSTANCE(BSP_BUZZER_MUSIC_TIMER);
    ...
    if(first==1)
    {
        ...
        *(uint32_t *)0x40008C0C = 1;
...
#endif			
        {
            ...
            nrf_drv_timer_extended_compare(&timer, NRF_TIMER_CC_CHANNEL0, 200 * 1000UL, NRF_TIMER_SHORT_COMPARE0_CLEAR_MASK, false);
...
#elif (defined(NRF51))
    nrf_drv_timer_extended_compare(&timer, NRF_TIMER_CC_CHANNEL0, 10000000UL/freq, NRF_TIMER_SHORT_COMPARE0_CLEAR_MASK, false);
#elif (defined(NRF52))	
	nrf_drv_timer_disable(&timer);
    nrf_drv_timer_extended_compare(&timer, NRF_TIMER_CC_CHANNEL0, 10000000UL/freq, NRF_TIMER_SHORT_COMPARE0_CLEAR_MASK, false);
	nrf_drv_timer_enable(&timer);
