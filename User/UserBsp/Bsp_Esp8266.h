...
typedef struct BSP_ESP8266_S_INFO
{
    ...
    uint8_t  Flag_ConnectAP	:1;	// 连接AP(0-未连接 1-已连接)
    uint8_t  Flag_Res6	  	:1;	// 
    uint8_t  Flag_Res7	  	:1;	// 
    uint8_t  Flag_Res8	  	:1;	// 
...
#include "nrf_delay.h"
extern void GprsNetAppXkap_Parse(uint8_t *pbuf,uint16_t len);
...
//#define BSP_ESP8266_CONNECT_1		"AT+CIPSTART=0,\"UDP\",\"59.46.22.16\",2012,8824,0\r\n"
#define BSP_ESP8266_CONNECT_1		"AT+CIPSTART=0,\"UDP\",\"dlisleep.xikang.com\",2012,8824,0\r\n"
#define BSP_ESP8266_RX_PARSE_CH1    GprsNetAppXkap_Parse
#define BSP_ESP8266_TEST_TX_ENABLE	0
...
#define BSP_ESP8266_TEST_TX_ENABLE	1
