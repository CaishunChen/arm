...
void BspDhtXX_ReadData(void)
{
    ...
    */
    ...
    {
#if     (BSP_DHTXX_CHIP ==  BSP_DHTXX_E_DHT11)
        BspDhtXX_s_Info.Temp    =   BspDhtXX_s_Info.Buf[2]*10;
        BspDhtXX_s_Info.Hum     =   BspDhtXX_s_Info.Buf[0]*10;
#elif   (BSP_DHTXX_CHIP ==  BSP_DHTXX_E_DHT22)
        BspDhtXX_s_Info.Hum=Count_2ByteToWord(BspDhtXX_s_Info.Buf[0],BspDhtXX_s_Info.Buf[1]);
        BspDhtXX_s_Info.Temp=Count_2ByteToWord(BspDhtXX_s_Info.Buf[2],BspDhtXX_s_Info.Buf[3]);
#endif
        return;
    }
quit:
