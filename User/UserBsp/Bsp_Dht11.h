...
typedef enum
{
    BSP_DHTXX_E_DHT11=0,		//温度：0-50°		/+-2%		湿度：20-90% /+-5%
    BSP_DHTXX_E_DHT22,			//温度：-40-80°	/+-0.5%		湿度：0-100% /+-2%
} BSP_DHTXX_E_CHIP;
typedef struct
{
...
#define BSP_DHTXX_DQ_OUT		
#define BSP_DHTXX_DQ_IN			
...
#define BSP_DHTXX_DQ_OUT		nrf_gpio_cfg_output(BSP_DHTXX_PIN);  
#define BSP_DHTXX_DQ_IN			nrf_gpio_cfg_input(BSP_DHTXX_PIN,NRF_GPIO_PIN_NOPULL);
#endif
/* Exported macro ------------------------------------------------------------*/
